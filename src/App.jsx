...
import { Upload, BarChart3, TrendingUp, Filter, Calendar } from 'lucide-react';
...
const AnimalWeightAnalyzer = () => {
  ...
  const [selectedIdade, setSelectedIdade] = useState('all'); // Nova funcionalidade
      ...
      Object.entries(animalGroups).forEach(([animalName, records]) => {
        ...
        if (gains.length > 0) {
          ...
          results.push({
            ...
            meses: lastRecord.MESES || lastRecord.meses || lastRecord.Meses || 0, // Nova propriedade
  ...
  const getFilteredData = () => {
    ...
    // Filtro por idade - NOVA FUNCIONALIDADE
    ...
    <div className="max-w-7xl mx-auto p-6 bg-gray-50 min-h-screen">
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Faça upload da sua planilha para analisar o ganho de peso diário por animal, pasto e idade
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!data && (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {(selectedPasto !== 'all' || selectedIdade !== 'all') && (
